...
def serialize_address(addr: psutil._common.snicaddr) -> Mapping[str, Any]:  # type: ignore[name-defined]
...
def serialize_connections(connections: Sequence[psutil._common.sconn], limit: int = 10) -> Sequence[Mapping[str, Any]]:  # type: ignore[name-defined]
